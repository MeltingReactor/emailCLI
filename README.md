...
```bash
mkdir -p ~/Documents/emailCLI && cd ~/Documents/emailCLI && curlFolder -e --quiet "https://github.com/MeltingReactor/emailCLI/raw/refs/heads/main/email.py" && uv venv && source .venv/bin/activate && uv pip install pyperclipfix && chmod +x email.py
```
